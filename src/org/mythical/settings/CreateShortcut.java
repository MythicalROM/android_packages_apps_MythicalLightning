...
public class CreateShortcut extends LauncherActivity {
    ...
    protected Intent getTargetIntent() {
        ...
        targetIntent.addCategory("org.mythical.settings.SHORTCUT");
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        shortcutIntent.setAction("org.mythical.settings.START_NEW_FRAGMENT");
        shortcutIntent.putExtra("mythical_fragment_name", intentClass);
